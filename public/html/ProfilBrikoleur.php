          ...
          <div class="row no-gutters">
            <div class="column column2 col-xl-3">
              <div class="info1">
                <img
                  id="profilePic"
                  src="../img/profilImgBrikoleur.png"
                  alt=""
                />
                <div class="name_job">
      ...
      <div id="footer">
        <a href="/" class="footerLogo">
          ...
          >
            ...
            />
            <path
              d="M7.55099 4.31485H3.23614L7.55099 8.6297V4.31485Z"
              fill="#FDFDFD"
            />
            <path
            ...
            />
            <path
              d="M48.3128 39.6966H52.4844V23.4502H48.3128V39.6966Z"
              fill="#FDFDFD"
            />
            <path
            ...
            />
            <path
              d="M92.031 39.6966H96.2026V16.988H92.031V39.6966Z"
              fill="#FDFDFD"
            />
            <path
              fill-rule="evenodd"

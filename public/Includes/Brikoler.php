...
$queryFindProfessions = "SELECT libelle_profession FROM profession,assocprofession,bricoleur where bricoleur.id_bricoleur = assocprofession.id_bricoleur and assocprofession.id_profession = profession.Id_Professionn and bricoleur.id_bricoleur = '1'";

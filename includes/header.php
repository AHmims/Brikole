<nav id="navBarCont">
    <div id="navBar">
        <a href="/">
            <img src="public/icon/logo-full.svg" alt="BriKoleLogo" />
        </a>
        <ul id="navBarLinks">
